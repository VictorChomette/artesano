...
Service.create!(
  title: 'France Plombier Paris 17eme',
  specialty: 'Plombier',
...
Service.create!(
  title: 'Dr. Chauffe Eau Paris 20eme',
  specialty: 'Plombier',
...
Service.create!(
  title: 'Talent Peinture Paris 4eme',
  specialty: 'Peintre',
...
Service.create!(
  title: 'Omnipeintres Boulogne-Billancourt',
  specialty: 'Peintre',
...
Service.create!(
  title: 'Pinceaux Déco Paris 15eme',
  specialty: 'Peintre',
...
Service.create!(
  title: 'Opération Jardin Issy-Les-Moulineaux',
  specialty: 'Jardinier',
...
Service.create!(
  title: 'Jardin du Prince Le Vésinet',
  specialty: 'Jardinier',
...
Service.create!(
  title: 'Experts des Espaces Verts Saint-Germain-en-Laye',
  specialty: 'Jardinier',
...
Service.create!(
  title: 'Magie Menuiserie Paris 14eme',
  specialty: 'Menuisier',
...
Service.create!(
  title: 'Menuisiers Astucieux Paris 12eme',
  specialty: 'Menuisier',
...
Service.create!(
  title: 'Doc Menuiserie Paris 9eme',
  specialty: 'Menuisier',
